...
new_classification = "faechersystematik.ttl"
...
new_notation_output = open("output/new_notations.csv", "w")
changed_label_output = open("output/changed_labels.csv", "w")
deprecated_notation_output = open("output/deprecated_notations.csv", "w")
